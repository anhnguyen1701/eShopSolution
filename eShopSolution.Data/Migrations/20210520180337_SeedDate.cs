    ...
    public partial class SeedDate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 5, 21, 1, 3, 36, 646, DateTimeKind.Local).AddTicks(7378), 100000m, 200000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "mo ta san pham", "vi-VN", "Áo nam", 1, "ao-nam", "Sản phẩm áo thời trang nam", "Sản phẩm áo thời trang nam" },
                    { 2, "", "desciption of product", "en-US", "men shirt", 1, "men-shirt", "the shirt products for men", "the shirt products for men" }
                });
        }
